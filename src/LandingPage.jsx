...
const STUDIOS = [
  ...
  },
  {
    ...
    desc: 'Ratio analysis, depreciation schedules, break-even analysis, and journal entry builder — your complete accounting workspace.',
    color: '#27ae60',
    tags: ['Ratio Analysis', 'Depreciation', 'Break-even', 'Journals'],
    status: 'active',
  },
  {
    id: 'economics',
    ...
    desc: 'GDP calculators, elasticity analysis, market equilibrium, and a comprehensive formula reference for economists.',
    color: '#f39c12',
    tags: ['Macroeconomics', 'Elasticity', 'Equilibrium', 'Formulas'],
    status: 'active',
  },
  {
    id: 'mathcalc',
    ...
    desc: 'Full scientific calculator with RAD/DEG, equation solver for quadratic/cubic/simultaneous, and sequence generator.',
    color: '#3498db',
    tags: ['Scientific Calc', 'Equation Solver', 'Sequences', 'Memory'],
    status: 'active',
  },
  {
    ...
    subtitle: 'Formulas, Ratios & Statements',
    desc: '30+ searchable accounting formulas, a full 20-ratio calculator, and an interactive income statement & balance sheet builder.',
    color: '#1abc9c',
    tags: ['Formula Library', 'Ratio Calculator', 'Income Statement', 'Balance Sheet'],
    status: 'active',
  },
]
